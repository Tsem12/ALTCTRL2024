...
public class CameraController : MonoBehaviour
{
    ...
    {
        WindDirection windDirection = WindScript.instance._windDirection;
        float windRollAngle = _windRollAngle;
        float windLateralTranslation = _windLateralTranslation;

        if (windDirection == WindDirection.West || windDirection == WindDirection.NorthWest || windDirection == WindDirection.SouthWest)
